#ifndef RAYMAN_LINE_UNLIT_FORWARD
#define RAYMAN_LINE_UNLIT_FORWARD
...
FragOutput Frag (Varyings input)
{
    ...
    const half3 fresnel = GetFresnelSchlick(viewDir, normal, _F0);
    baseColor.rgb = lerp(baseColor.rgb, _FresnelColor.rgb, fresnel);
