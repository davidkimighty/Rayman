	Shader "Rayman/LineUnlit"
{
    Properties
    {
    	...
    	_F0("F0", Float) = 0.04
    	_FresnelColor ("Fresnel Color", Color) = (1.0, 0.93, 0.93, 1)
    ...
    SubShader
    {
        ...
        Pass
		{
			...
			#include "Packages/com.davidkimighty.rayman/Shaders/Unlit/LineUnlitForwardPass.hlsl"
            ENDHLSL
		}
    }
    FallBack "Diffuse"
