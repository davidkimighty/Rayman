Shader "Rayman/SplineChrome"
{
    ...
    SubShader
    {
        ...
        Pass
		{
			...
			#include "Packages/com.davidkimighty.rayman/Shaders/Sdf/SplineSurface.hlsl"
			
			#pragma vertex Vert
            #pragma fragment Frag
			#include "Packages/com.davidkimighty.rayman/Shaders/Sdf/SplineChromeForwardPass.hlsl"
            ENDHLSL
		}
