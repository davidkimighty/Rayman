	Shader "Rayman/MengerSponge"
{
    ...
    SubShader
    {
        ...
        Pass
		{
			...
			#include "Packages/com.davidkimighty.rayman/Samples/MengerSponge/MengerSpongeForwardPass.hlsl"
            ENDHLSL
		}
		...
		Pass
		{
			...
			#include "Packages/com.davidkimighty.rayman/Samples/MengerSponge/MengerSpongeShadowCasterPass.hlsl"
			ENDHLSL
		}
    }
    FallBack "Diffuse"
